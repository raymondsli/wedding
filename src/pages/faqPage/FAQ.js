...
const questionAndAnswersChinese = {
  ...
  "我可以帶一位同行賓客嗎？":
    "由於場地和座位限制，我們請您只為自己回覆 (RSVP)，除非我們明確告知您可以攜伴。如果您不確定，隨時可以向我們詢問。",
  "有哪些住宿選擇？":
    "如果您需要住宿，場地附近有幾家飯店可供選擇。我們則會入住 Laguna Cliffs Marriott Resort & Spa。",
  "場地是室內還是室外？":
    "儀式將在 Pines Park 舉行，這是一個戶外的公共公園。晚宴則是在 Whitestone 餐廳的私人室內包廂，距離公園約 10 分鐘車程。",
  "儀式場地有停車位嗎？":
    "有的，公園有有限的街邊停車位，且該地區為住宅區，還有其他街邊停車位可供使用。",
  "儀式場地有洗手間嗎？":
